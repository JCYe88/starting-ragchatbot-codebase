...
class CourseSearchTool(Tool):
    ...
    def __init__(self, vector_store: VectorStore):
        ...
        self.last_sources: list[dict] = []  # Track sources from last search: [{label, url}]
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Build label and resolve lesson link
            label = course_title
            if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the complete outline of a course: title, course link, and all lessons with their numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
